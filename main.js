var combinationDBkr = [
    ["서포터", "★5 프라마닉스, 이스티나, 메이어 ★4 어스스피릿"],
    ["신입", "★2 확정"],
    ["특별채용", "★5 확정"],
    ["고급특별채용", "★6 시즈, 샤이닝, 나이팅게일, 이프리트, 엑시아, 실버애쉬, 호시구마, 사리아, 스카디"],
    ["강제이동", "★5 클리프하트, 에프이터, 크루아상 ★4 로프, 쇼"],
    ["서포트", "★5 지마, 프틸롭시스, 와파린 ★4 도베르만"],
    ["디버프", "★5 메테오리테, 프라마닉스 ★4 헤이즈, 메테오"],
    ["스페셜리스트", "★5 레드, 만티코어, 클리프하트, 에프이터 ★4 쇼, 로프, 그라벨"],
    ["소환", "★5 메이어"],
    ["로봇", "★1 Lancet-2, Castle-3"],
    ["누커", "★5 파이어워치"],
    ["뱅가드", "서포트", "★5 지마"],
    ["코스트+", "서포트", "★5 지마"],
    ["뱅가드", "제어형", "★5 텍서스"],
    ["코스트+", "제어형", "★5 텍서스"],
    ["범위공격", "디버프", "★5 메테오리테"],
    ["스페셜리스트", "강제이동", "★5 클리프하트, 에프이터 ★4 로프, 쇼"],
    ["메딕", "서포트", "★5 프틸롭시스, 와파린"],
    ["서포트", "힐링", "★5 프틸롭시스, 와파린"],
    ["서포트", "원거리", "★5 프틸롭시스, 와파린"],
    ["가드", "생존형", "★5 스펙터, 인드라"],
    ...
    ["제어형", "★5 레드, 텍사스, 메이어"],
    ["제어형", "근거리", "★5 텍사스, 레드"],
    ["범위공격", "스나이퍼", "★5 메테오리테 ★4 시라유키"],
    ["범위공격", "감속", "★4 시라유키"],
    ["생존형", "스나이퍼", "★4 제시카"],
    ["생존형", "원거리", "★4 제시카"],
    ["디버프", "스나이퍼", "★5 메테오리테, ★4 메테오"],
    ["디버프", "캐스터", "★4 헤이즈"],
    ["서포트", "가드", "★4 도베르만"],
    ["서포트", "딜러" ,"★4 도베르만"],
    ["범위공격", "가드", "★5 스펙터 ★4 에스텔"],
    ["범위공격", "생존형", "★5 스펙터 ★4 에스텔"],
    ["범위공격", "근거리", "★5 스펙터 ★4 에스텔"],
    ["감속", "가드", "★4 프로스트리프"],
    ["힐링", "방어형", "★4 니어, 굼"],
    ["힐링", "디펜더", "★4 니어, 굼"],
    ["힐링", "근거리", "★4 니어, 굼"],
    ...
    ["쾌속부활", "방어형", "★4 그라벨"],
    ["디버프", "딜러", "★4 헤이즈, 메테오"],
    ["감속", "근거리", "★5 에프이터 ★4 프로스트리프"],
    ["감속", "딜러", "★5 이스티나 ★4 프로스트리프"],
    ["서포트", "근거리", "★5 지마 ★4 도베르만"],
    ["로봇", "원거리", "★1 Lancet-2"],
    ["로봇", "힐링", "★1 Lancet-2"],
    ["로봇", "근거리", "★1 Castle-3"],
    ["로봇", "가드", "★1 Castle-3"],
    ["고급특별채용", "근거리", "★6 시즈, 실버애쉬, 호시구마, 사리아"],
    ["고급특별채용", "원거리", "★6 샤이닝, 나이팅게일, 이프리트, 엑시아"],
    ["고급특별채용", "디펜더", "★6 호시구마, 사리아"],
    ["고급특별채용", "힐링", "★6 샤이닝, 나이팅게일, 사리아"],
    ["고급특별채용", "캐스터", "★6 이프리트"],
    ["고급특별채용", "범위공격", "★6 이프리트"],
    ["고급특별채용", "디버프", "★6 이프리트"],
    ["고급특별채용", "메딕", "★6 샤이닝, 나이팅게일"],
    ["고급특별채용", "원거리", "힐링", "★6 샤이닝, 나이팅게일"],
    ["고급특별채용", "원거리", "서포트", "★6 샤이닝, 나이팅게일"],
    ["고급특별채용", "원거리", "딜러", "★6 엑시아"],
    ["고급특별채용", "스나이퍼", "★6 엑시아"],
    ["고급특별채용", "디펜더", "힐링", "★6 사리아"],
    ["고급특별채용", "디펜더", "서포트", "★6 사리아"],
    ["고급특별채용", "방어형", "서포트", "★6 사리아"],
    ["고급특별채용", "방어형", "힐링", "★6 사리아"],
    ["고급특별채용", "디펜더", "딜러", "★6 호시구마"],
    ["고급특별채용", "방어형", "딜러", "★6 사리아"],
    ["고급특별채용", "딜러", "서포트", "★6 실버애쉬"],
    ["고급특별채용", "가드", "★6 실버애쉬, 스카디"],
    ["고급특별채용", "남성대원", "★6 실버애쉬"],
    ["고급특별채용", "코스트+", "★6 시즈"],
    ["고급특별채용", "뱅가드", "★6 시즈"],
    ["고급특별채용", "생존형" ,"★6 스카디"]
